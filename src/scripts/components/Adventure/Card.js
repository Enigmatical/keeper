            ...
            <div className="item-card adventure-card">
                ...
                <div className="card-footer">
                    <ButtonToolbar className="pull-left">
                        <InfoModal target={this.props.target} save={this.props.save} info={this.props.getInfo()} canComplete={this.props.canComplete} canTravel={this.props.canTravel} onComplete={this.onComplete} onTravel={this.props.onTravel} onSave={this.props.getSave} />
